...
def fetch_template(type: t.Literal["SSR"] | t.Literal["SSG"], dest: Path) -> None:
    """
    Fetches the template from the emuleo-templates repository.
    ...
    try:
        ...
        print(
            "[bold magenta italic]Try running the '--help' flag for more information."
        )
