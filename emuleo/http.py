...
from emuleo.utils.common import create_file_from_route, emulog, send_response
from emuleo.utils.http import (
...
class SSG:
    ...
    async def build(self, dest: Path) -> None:
        ...
        console.print("[#8B5CF6 bold]\n✅ Build complete\n[/#8B5CF6 bold]")
        console.print(
            "[#FACC15 bold]⚠ Make sure to fix the srcs and hrefs of scripts and stlyes[/#FACC15 bold]"
        )
